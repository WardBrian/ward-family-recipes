...
\begin{ingreds}
    ...
    1 lb of mozzarella cheese, sliced \quarter{} inch thick
    Kosher salt
...
\begin{ingreds}
    ...
    3 tablespoon Parmesan cheese, plus more to top
...
\recipe[A version of Conchiglie alla Burina]{Pasta with Rustic Sauce}

\begin{ingreds}
    1 lb conchiglie (shells) or other short pasta
    3 tablespoons butter
    1 small onion
    14 oz tinned Italian plum tomatoes
    salt and black pepper
    7 oz large pork sausages
    1 glass white wine
    1 cup shelled peas (optional)
\end{ingreds}

\begin{method}
    Melt the butter and add the finely chopped onion and garlic. When the onion begins to turn cxolor add the tomatoes and their juice. Season to taste with salt and black pepper. Cook for 20 minutes.

    Meanwhile, prick the sausages and cook them gently in the wine in a separate covered pan. When they are cooked, strain their liquid into the tomatoes. Skin the sausages and slice them into rounds.

    Cook the pasta, following the box instructions. Add the peas to the tomatoes cooking until just tender. Before draining the pasta
    add the sausages to tomatoes. Drain the pasta, place into a warm serving dish, and top with the sauce. Serve with Parmesian or pecorino cheese.

\end{method}

\begin{notes}
Annotated ``Wow 2/14/00''
\end{notes}

\recipe[Modified from a recipe by Carissa Stanton.]{Spring Orzo Pasta Salad with Crispy Shallot Vinaigrette}
\index{Pasta!orzo}
\serves{4}
\cooktime{20 minutes}
...
\begin{method}
    For the vinaigrette, heat the olive oil in a skillet over medium heat. Add the shallots and stir until they’re golden brown, taking care not to burn them.

    Add the shallots and oil to a jar or bowl and combine with remaining ingredients. Set aside.

    Cook orzo according to package.

    Lightly saut\'{e} the asparagus in a drizzle of olive oil for 3-4 minutes or until cooked to your liking.
...
\index{Pork!loin}
\preptime{10 minutes}
\cooktime{60 minutes + rest}

\begin{ingreds}
    4-5 lbs pork loin roast trimmed of skin and fat
    1\half{} tablespoons olive oil divided
    \half{} cup low sodium beef stock or chicken stock/broth
    \half{} cup water
...
\begin{method}[Preheat oven to \temp{350}]
    ...
    Heat remaining oil (about 2 teaspoons) in a large pan or skillet over medium heat. Sear pork all over until golden browned, rotating the pork around to avoid spices burning. Move browned pork into a roasting pan.

    For the sauce, melt butter in the same pan the pork was in while scraping up any leftover bits in the pan. Add garlic and saut\'{e} for 1 minute until fragrant. Stir in remaining sauce ingredients; bring to a rapid simmer for 1 minute.

    Reserve \half{} cup sauce for basting. Pour remaining sauce over pork.
    Pour \half{} cup stock and \half{} cup water around the pork.
    ...
    Baste again and roast for a further 10-15 minutes, or until a meat thermometer registers \temp{145} in the thickest part.

    Transfer pork onto serving plate and baste with pan juices. Tent loosely with foil and let rest for 10-15 minutes.

    Scrape up any browned bits leftover in the pan, mixing them through the pan juices and pour juices into a pot. Whisk cornstarch into an additional \half{} cup water, whisk cornstarch slurry into the sauce and bring to a simmer. Slowly add in \quarter{}-\half{} cup water additional, if needed, until reaching a honey-like consistency. (Please note: sauce will thicken as it cools).
...
\recipe[A Ward classic that I'm pretty sure has nothing to do with the French dish. Her own recipe book also calls it Hungarian Goulash.]{Alicia's ``Beef Bourguignon''}
\index{Beef!stew}
\serves{6-8}
\preptime{10 minutes}
\cooktime{9-10 hours}
...
\begin{method}
    ...
    Combine garlic, ketchup, Worcestershire sauce, sugar, salt, paprika, and mustard. Stir in 1 cup water. Pour over meat.

    Cover and cook on low for 9-10 hours (or 4-5 on high).

    Dissolve flour in a small amount of cold water, stir into meat mixture.
...
\begin{notes}
    ...
    \half{} teaspoon Cayenne for every 1 teaspoon Indian red chili powder
...
\begin{ingreds}
    4 eggs, beaten
    \quarter{} cup (1 ounce) grated fresh Parmesan cheese
    ...
    2 tablespoon butter
    \quarter{} cup dry white wine
    3 additional tablespoon lemon juice
\end{ingreds}

\begin{method}
    Combine first 8 ingredients in a shallow dish.

    Place each chicken breast half between 2 sheets of plastic wrap, and pound to \quarter{} inch thickness.

    Dredge chicken in flour, and dip in the egg mixture.

    Heat 1\half{} teaspoons oil in a large skillet over medium heat. Add 4 chicken breast halves; cook 4 minutes on each side or until done. Remove chicken from pan; keep warm. Wipe the drippings from pan with a paper towel. Repeat the procedure with 1\half{} teaspoons oil and the remaining chicken.

    Melt butter in pan; add \quarter{} cup wine and 3 tablespoons juice. Bring to a boil, cook for 10 seconds. Serve immediately
    over chicken.
...
\begin{ingreds}
    1 pork shoulder, between 5 and 8 lbs
...
\begin{ingreds}
    ...
    1 teaspoon garlic powder
    1 teaspoon onion powder
    \half{} tteaspoonsp smoked paprika
...
\begin{method}
    \textbf{Season and bring to room temperature:} Take the pork chops out of the refrigerator and season both sides with salt (a little less than 1/4 teaspoon per chop). Let them rest at room temperature for 30 minutes.

    \textbf{Make spice rub:} Meanwhile, in a small bowl, mix the flour, chili powder, garlic powder, onion powder, smoked paprika, and 1/2 teaspoon of black pepper.

    \textbf{Add spice rub:} After 30 minutes, pat the chops dry with paper towels, then rub the spice mixture all over.

    \textbf{Cook the pork chops:} Heat the oil in a skillet (with a lid) over medium-high heat. When the oil is hot and looks shimmery, add the pork. Cook until golden, 2 to 3 minutes.
    ...
    \textbf{Let them rest:} Transfer the pork chops to a plate, then loosely cover them with aluminum foil. Let the pork rest for 5 minutes.

    \textbf{Make pan sauce:} While the pork rests, make the pan sauce right in the same skillet. Increase the heat to medium-high, then add the chicken stock, vinegar, and honey. Bring the sauce to a simmer and cook until reduced by half. As it simmers, use a wooden spoon to scrape the bottom of the pan so that any stuck bits of pork come up. Taste, then adjust with additional salt, vinegar, or honey.

    \textbf{Add the butter:} Slide the skillet off the heat, wait until the sauce stops simmering, then swirl in the butter.

    \textbf{Serve:} Return the pork chops to the pan and spoon the sauce over them. Or slice the chops and toss the slices in the sauce. Sprinkle with fresh parsley and serve.
\end{method}
...
\begin{ingreds}
    \threequarters{} lbs skinless, boneless chicken breasts
    3 slices of bacon
    2 cloves garlic, minced
...
\begin{ingreds}
    1 lb cranberries
    Zest (1 tablespoon) and juice (\quarter{} cup) of 1 navel orange
    \threequarters{} cup packed light brown sugar
    \half{} teaspoon ground cardamom
    \sfrac{1}{8} teaspoon salt
\end{ingreds}
...
\begin{ingreds}
    3 lbs red potatoes, rinsed and scrubbed clean, cut into 1 inch pieces
    1 cup mayonnaise
...
\recipe[Recipe by \href{https://www.americastestkitchen.com/articles/7939-how-to-make-Beurre-Mont\%C3\%A9}{America's Test Kitchen}.]{Beurre Mont\'{e}}
\cooktime{10 minutes}

\begin{ingreds}
    3 teaspoons water
    8 teaspoons cold butter, cubed
\end{ingreds}
...
\begin{method}[Preheat oven to \temp{350}]
    ...
    Roll cookie dough into balls, about 1-1\half{} tablespoons of dough per cookie, and arrange 3 inches apart on the baking sheets. Bake for 12-13 minutes or until lightly browned on the sides. The centers will look soft.
